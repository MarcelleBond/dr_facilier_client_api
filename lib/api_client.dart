...
class ApiClient {
  ApiClient({this.basePath = 'https://dr-facilier.thegodbox.co.za/api/v1', this.authentication,});
    ...
    try {
      switch (targetType) {
        ...
        case 'PlatformDetails':
          return PlatformDetails.fromJson(value);
        case 'PlatformInput':
          return PlatformInput.fromJson(value);
        case 'RegisterInput':
          return RegisterInput.fromJson(value);
        case 'Song':
          return Song.fromJson(value);
        case 'SongDetails':
          return SongDetails.fromJson(value);
        case 'SongInput':
          return SongInput.fromJson(value);
